...
extension ValuesExt on DatabaseProvider {
  ...
  Map<String, dynamic> getLessonValues(Lesson lesson) => {
        ...
        "statusDescription": lesson.status.description,
        "statusName": lesson.status.name,
        "typeId": lesson.type.id,
        "typeDescription": lesson.type.description,
        "typeName": lesson.type.name,
        "lessonIndex": lesson.lessonIndex,
        "lessonYearIndex": lesson.lessonYearIndex,
        "teacher": lesson.teacher,
        "substituteTeacher": lesson.substituteTeacher,
        "date": lesson.date.toUtc().toIso8601String(),
